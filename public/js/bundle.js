    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)(_context3.t0, 'Error logging out! Try again');
...
var submitReview = exports.submitReview =
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2h5anMiLCJhIjoiY2x5aGVlOHc2MDJnZzJqcTE5ZGY2dmVodSJ9.fmBKHUZHTYbNdG3EazI1Yg';
...
// Type is eithor 'password' or 'data'
...
var stripe = Stripe('pk_test_51PdC9uHURZYMsx25BiTkwq8rdG2tgt2CfgjOvJfHCt6LozQov3lvCKCC4auXboY07DbofNJoKUZRHl9oIp0rpYgb008bdgVCz9');
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(tourId, selectedDate) {
    var session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(tourId, "/").concat(selectedDate));
        ...
        case 8:
          ...
          (0, _alert.showAlert)('errer', _context.t0);
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    var _e$target$dataset = e.target.dataset,
        ...
        selectedDate = _e$target$dataset.selectedDate;

    if (!selectedDate) {
      (0, _alert.showAlert)('error', 'Please select an available date first!!', 8);
      return false;
    }
